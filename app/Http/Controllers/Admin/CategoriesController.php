...
class CategoriesController extends AdminController
{
     ...
     * @return Response
     */
    public function create( ProjectsRepository $projectsRepository )
    {
        $projects = $projectsRepository->optionArray();
        $categories = $this->repository->optionArray();

        return view( 'admin.categories.create', compact( '$projects', 'categories' ) );
    }
     ...
     * @return Response
     */
    public function edit( Category $category, ProjectsRepository $projectsRepository )
    {
        if ( !$category->id )
        {
        ...
        return view( 'admin.categories.edit', compact( 'category', 'projects', 'categories' ) );
    }
