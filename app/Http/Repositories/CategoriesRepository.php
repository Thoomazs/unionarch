<?php
    ...
    class CategoriesRepository extends BaseRepository
    {
        ...
        {
            return $this->category->with( 'projects' )->orderBy( "order", "ASC" );
        }
        ...
        protected function _createOrUpdate( Category $category, array $category_data )
        {
            ...
            $category_data[ 'projects' ] = ( isset( $category_data[ 'projects' ] ) ) ? $category_data[ 'projects' ] : [ ];
            $category->projects()->sync( $category_data[ 'projects' ] );
