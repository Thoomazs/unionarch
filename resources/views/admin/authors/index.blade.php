...
@section('content')
        ...
        <div class="controls">
            <div class="row">
                ...
                <div class="col-sm-4 hidden-xs">
                        <a href="{{ route('admin.authors.create') }}" class="create btn btn-success">
                            <i class="fa fa-plus"></i>
                        </a>
                </div>
                <div class="col-sm-4">
                    <div class="pull-right">
                        @include("templates.pagination", ["paginator" => $authors, "type" => "simple"])
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="table-responsive">
                ...
                @if( count( $authors) > 0)
                    ...
                    @foreach($authors as $author)
                        <tr>
                            ...
                            <td>
                                {{ count($author->projects) }}
                            </td>
                            <td class="actions">
                                <a class="update btn btn-xs btn-default" href="{{ route('admin.authors.edit', [$author->id] ) }}" title="Edit">
                                    <i class="fa fa-pencil"></i>
                                </a>

                                <div class="inline-block" title="Delete">

                                    {!! Form::open(array('route' => ['admin.authors.destroy', $author->id ], 'method' => 'DELETE')) !!}
            ...
            <div class="controls overflow-hidden">
                <div class="pull-right">
                       @include("templates.pagination", ["paginator" => $authors])
                </div>
            </div>
            @endif
